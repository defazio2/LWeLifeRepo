...
ThreadSafe function ts_wnoteDuration( wn )
string wn // wavename
	...
	if( strlen( durstr ) > 0 )
		...
		print "WARNING: COULD NOT GET DURATION FROM NOTE"
	endif
return duration
end
...
ThreadSafe function ts_wnoteVarByKey( wn, key )
string wn, key // wavename
	...
	if( strlen( durstr ) > 0 )
		...
		print "ERROR: COULD NOT GET DURATION FROM NOTE"
	endif
return duration
end
