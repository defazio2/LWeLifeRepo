...
function APpropV2_2(trace, smoothing,dthreshold, [disp, delay, scale] )
...
//	print "Using minslope = ",minslope,". For GNRH action potentials, this should be 1!"
	...
	string wlist = winlist("*", ";", ""), thiswin = stringfromlist( 0, wlist )
	...
	variable interval, APloc, APloc_corrected, APamp, APFWHM
	...
	variable frontrange=5e-3, backrange=10e-3 // assumes units are seconds!!! back was 3msec 20181016
	variable ahp_offset = 0.005 //20181024 //0.02 // look for the AHP minium within 20 msec of AP peak loc
